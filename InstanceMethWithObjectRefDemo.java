...
class InstanceMethWithObjectRefDemo {
	...
	// A method that returns the number of occurances
	...
	public static void main(String args[]) 
	{
		...
		// sameTemp() is passed as thesecond argument.
		...
		// Now, use lessThanTemp() to find days whan temperature was less 
		...
		System.out.println(count + " days had  hih of less than 19");							 							
	}
}